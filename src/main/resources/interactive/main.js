...
var _user$project$Main$viewCycles = F2(
			...
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A2(
						...
						A2(
							_elm_lang$core$List$map,
							_user$project$Main$viewCycle(toLabel),
							cycles)),
					_1: {ctor: '[]'}
				}
			});
	});
var _user$project$Main$defaultLayout = _justinmimbs$elm_arc_diagram$ArcDiagram$defaultLayout;
var _user$project$Main$layout = _elm_lang$core$Native_Utils.update(
	_user$project$Main$defaultLayout,
	{labelWidth: 400});
var _user$project$Main$drawGraph = F2(
	function (_p0, selectedNode) {
		var _p1 = _p0;
		var toLabel = function (_p2) {
			return A2(
				_elm_lang$core$Maybe$withDefault,
				'',
				A3(_elm_lang$core$Basics$flip, _elm_lang$core$Dict$get, _p1._0, _p2));
		};
		var graphView = function () {
			var _p3 = _justinmimbs$elm_arc_diagram$AcyclicDigraph$fromEdges(_p1._1);
			if (_p3.ctor === 'Err') {
				return A2(_user$project$Main$viewCycles, toLabel, _p3._0);
			} else {
				var _p4 = _p3._0;
				var paint = A2(
					_elm_lang$core$Maybe$withDefault,
					_justinmimbs$elm_arc_diagram$ArcDiagram$basicPaint(toLabel),
					A2(
						_elm_lang$core$Maybe$map,
						A2(_justinmimbs$elm_arc_diagram$ArcDiagram_Distance$basicPaint, toLabel, _p4),
						selectedNode));
				return A3(_justinmimbs$elm_arc_diagram$ArcDiagram$view, _user$project$Main$layout, paint, _p4);
			}
		}();
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'margin', _1: '40px'},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'font-family', _1: 'Helvetica, Arial, san-serif'},
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _user$project$Main$view = function (_p5) {
	var _p6 = _p5;
	return A2(_user$project$Main$drawGraph, _p6.graph, _p6.selectedNode);
};
	...
	function (node, model) {
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{
					selectedNode: A2(_user$project$Main$toggleMaybe, node, model.selectedNode)
				}),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
var _user$project$Main$edges = function (dependencies) {
	return _elm_lang$core$Set$fromList(
		A2(
			_elm_lang$core$List$map,
			function (dependency) {
				return {ctor: '_Tuple2', _0: dependency.from, _1: dependency.to};
			},
			dependencies));
};
var _user$project$Main$labels = function (artifacts) {
...
var _user$project$Main$Model = F2(
	function (a, b) {
		return {graph: a, selectedNode: b};
	});
var _user$project$Main$init = function (dependencyGraph) {
	return {
		ctor: '_Tuple2',
		_0: A2(
			...
			{
				ctor: '_Tuple2',
				_0: _user$project$Main$labels(dependencyGraph.artifacts),
				_1: _user$project$Main$edges(dependencyGraph.dependencies)
			},
			_elm_lang$core$Maybe$Nothing),
		_1: _elm_lang$core$Platform_Cmd$none
	};
...
var _user$project$Main$Artifact = F3(
	function (a, b, c) {
		return {id: a, artifactId: b, version: c};
	});
var _user$project$Main$Dependency = F4(
	function (a, b, c, d) {
		return {from: a, to: b, resolution: c, scopes: d};
	});
var _user$project$Main$DependencyGraph = F2(
	function (a, b) {
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{},"aliases":{},"message":"Int"},"versions":{"elm":"0.18.0"}});
}
