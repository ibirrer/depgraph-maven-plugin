...
var _ferstl$depgraph_maven_plugin$DistancePaint$isNothing = function (m) {
	var _p0 = m;
	if (_p0.ctor === 'Just') {
		return false;
	} else {
...
var _ferstl$depgraph_maven_plugin$DistancePaint$rgba = F4(
	function (r, g, b, a) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'rgba(',
...
var _ferstl$depgraph_maven_plugin$DistancePaint$greenFromAlpha = A3(_ferstl$depgraph_maven_plugin$DistancePaint$rgba, 0, 140, 72);
var _ferstl$depgraph_maven_plugin$DistancePaint$purpleFromAlpha = A3(_ferstl$depgraph_maven_plugin$DistancePaint$rgba, 180, 56, 148);
var _ferstl$depgraph_maven_plugin$DistancePaint$colorFromDistance = function (distance) {
	var _p1 = distance;
	if (_p1.ctor === 'Just') {
		var _p2 = _p1._0;
		if (_elm_lang$core$Native_Utils.eq(_p2, 0)) {
			...
			var colorFromAlpha = (_elm_lang$core$Native_Utils.cmp(_p2, 0) > 0) ? _ferstl$depgraph_maven_plugin$DistancePaint$purpleFromAlpha : _ferstl$depgraph_maven_plugin$DistancePaint$greenFromAlpha;
			return colorFromAlpha(
				1 - ((A2(
					_elm_lang$core$Basics$min,
					3,
...
var _ferstl$depgraph_maven_plugin$DistancePaint$distanceForEdge = F2(
	function (distancesFrom, _p3) {
		var _p4 = _p3;
		return A2(
			_elm_lang$core$Maybe$withDefault,
...
var _ferstl$depgraph_maven_plugin$DistancePaint$labelColor = function (isDimmed) {
	return isDimmed ? 'rgb(200, 200, 200)' : 'black';
};
var _ferstl$depgraph_maven_plugin$DistancePaint$viewLabelDimmed = F2(
	function (isDimmed, string) {
		return A2(
			_elm_lang$svg$Svg$text_,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$fontFamily('\'Source Sans Pro\', \'Trebuchet MS\', \'Lucida Grande\', \'Bitstream Vera Sans\', \'Helvetica Neue\', sans-serif'),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$fill(
									_ferstl$depgraph_maven_plugin$DistancePaint$labelColor(isDimmed)),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _ferstl$depgraph_maven_plugin$DistancePaint$defaultDistancePaint = {
	viewLabel: F2(
		function (n, d) {
			return A2(
				_ferstl$depgraph_maven_plugin$DistancePaint$viewLabelDimmed,
				_ferstl$depgraph_maven_plugin$DistancePaint$isNothing(d),
				_elm_lang$core$Basics$toString(n));
		}),
	colorNode: _elm_lang$core$Basics$always(_ferstl$depgraph_maven_plugin$DistancePaint$colorFromDistance),
	colorEdge: _elm_lang$core$Basics$always(_ferstl$depgraph_maven_plugin$DistancePaint$colorFromDistance)
};
var _ferstl$depgraph_maven_plugin$DistancePaint$basicPaint = F2(
	function (toLabel, colorEdge) {
		return _justinmimbs$elm_arc_diagram$ArcDiagram_Distance$paint(
			_elm_lang$core$Native_Utils.update(
				_ferstl$depgraph_maven_plugin$DistancePaint$defaultDistancePaint,
				{
					viewLabel: F2(
						function (n, d) {
							return A2(
...
var _ferstl$depgraph_maven_plugin$Main$toggleMaybe = F2(
	function (a, ma) {
		return _elm_lang$core$Native_Utils.eq(
			ma,
			_elm_lang$core$Maybe$Just(a)) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(a);
	});
var _ferstl$depgraph_maven_plugin$Main$viewCycle = F2(
	function (toLabel, cycle) {
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: _elm_lang$html$Html$text(
					A2(
						_elm_lang$core$String$join,
						' -> ',
						A2(_elm_lang$core$List$map, toLabel, cycle))),
				_1: {ctor: '[]'}
			});
	});
var _ferstl$depgraph_maven_plugin$Main$viewCycles = F2(
	function (toLabel, cycles) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Graph has the following cycles:'),
				_1: {
					ctor: '::',
					_0: A2(
						...
						A2(
							_elm_lang$core$List$map,
							_ferstl$depgraph_maven_plugin$Main$viewCycle(toLabel),
							cycles)),
					_1: {ctor: '[]'}
				}
			});
	});
var _ferstl$depgraph_maven_plugin$Main$edgeColorDuplicate = function (intesity) {
	var _p0 = intesity;
	switch (_p0.ctor) {
		case 'Dark':
			return 'rgba(24, 90, 169, 0.8)';
		case 'Middle':
			return 'rgba(24, 90, 169, 0.4)';
		default:
			return 'rgba(24, 90, 169, 0.1)';
	}
};
var _ferstl$depgraph_maven_plugin$Main$edgeColorIncluded = function (intesity) {
	var _p1 = intesity;
	switch (_p1.ctor) {
		case 'Dark':
			return 'rgba(1, 2, 2, 0.8)';
		case 'Middle':
			return 'rgba(1, 2, 2, 0.4)';
		default:
			return 'rgba(1, 2, 2, 0.1)';
	}
};
var _ferstl$depgraph_maven_plugin$Main$edgeColorConflict = function (intesity) {
	var _p2 = intesity;
	switch (_p2.ctor) {
		case 'Dark':
			return 'rgba(238, 46, 47, 0.8)';
		case 'Middle':
			return 'rgba(238, 46, 47, 0.4)';
		default:
			return 'rgba(238, 46, 47, 0.1)';
	}
};
var _ferstl$depgraph_maven_plugin$Main$colorError = 'red';
var _ferstl$depgraph_maven_plugin$Main$edgeColor = F3(
	function (dependencyDict, colorIntensity, edge) {
		var _p3 = A2(_elm_lang$core$Dict$get, edge, dependencyDict);
		if (_p3.ctor === 'Nothing') {
			return _ferstl$depgraph_maven_plugin$Main$colorError;
		} else {
			var _p4 = _p3._0.resolution;
			switch (_p4) {
				case 'INCLUDED':
					return _ferstl$depgraph_maven_plugin$Main$edgeColorIncluded(colorIntensity);
				case 'OMITTED_FOR_DUPLICATE':
					return _ferstl$depgraph_maven_plugin$Main$edgeColorDuplicate(colorIntensity);
				case 'OMITTED_FOR_CONFLICT':
					return _ferstl$depgraph_maven_plugin$Main$edgeColorConflict(colorIntensity);
				default:
					return _ferstl$depgraph_maven_plugin$Main$colorError;
			}
		}
	});
var _ferstl$depgraph_maven_plugin$Main$toMaybe = F2(
	function (isOn, name) {
		return isOn ? _elm_lang$core$Maybe$Just(name) : _elm_lang$core$Maybe$Nothing;
	});
var _ferstl$depgraph_maven_plugin$Main$containsAny = F2(
	function (items, list) {
		containsAny:
		while (true) {
			var _p5 = items;
			if (_p5.ctor === '::') {
				if (A2(_elm_lang$core$List$member, _p5._0, list)) {
					return true;
				} else {
					var _v6 = _p5._1,
						_v7 = list;
...
var _ferstl$depgraph_maven_plugin$Main$containsAnySubstring = F2(
	function (substrings, string) {
		containsAnySubstring:
		while (true) {
			var _p6 = substrings;
			if (_p6.ctor === '::') {
				if (A2(_elm_lang$core$String$contains, _p6._0, string)) {
					return true;
				} else {
					var _v9 = _p6._1,
						_v10 = string;
...
var _ferstl$depgraph_maven_plugin$Main$filterEdges = function (model) {
	var excludedNodes = _elm_lang$core$Dict$keys(
		A2(
			_elm_lang$core$Dict$filter,
			F2(
				function (id, artifact) {
					return (!_elm_lang$core$Native_Utils.eq(model.excludeFilter, '')) && A2(
						_ferstl$depgraph_maven_plugin$Main$containsAnySubstring,
						A2(_elm_lang$core$String$split, ',', model.excludeFilter),
						artifact.artifactId);
				}),
			model.graphLookup.artifactDict));
	var excludedNodesFilter = F2(
		function (edge, dependeny) {
			return (!A2(
				_elm_lang$core$List$member,
				_elm_lang$core$Tuple$first(edge),
				excludedNodes)) && (!A2(
				_elm_lang$core$List$member,
				_elm_lang$core$Tuple$second(edge),
				excludedNodes));
		});
	var includedNodes = _elm_lang$core$Dict$keys(
		A2(
			_elm_lang$core$Dict$filter,
			F2(
				function (id, artifact) {
					return A2(
						_ferstl$depgraph_maven_plugin$Main$containsAnySubstring,
						A2(_elm_lang$core$String$split, ',', model.includeFilter),
						artifact.artifactId);
				}),
			model.graphLookup.artifactDict));
	var includedNodesFilter = F2(
		function (edge, dependeny) {
			return A2(
				_elm_lang$core$List$member,
				_elm_lang$core$Tuple$first(edge),
	...
	var scopeFilter = F2(
		function (edge, dependency) {
			return A2(
				_ferstl$depgraph_maven_plugin$Main$containsAny,
				dependency.scopes,
				A2(
					...
					{
						ctor: '::',
						_0: A2(_ferstl$depgraph_maven_plugin$Main$toMaybe, model.scopeFilter.showCompile, 'compile'),
						_1: {
							ctor: '::',
							_0: A2(_ferstl$depgraph_maven_plugin$Main$toMaybe, model.scopeFilter.showProvided, 'provided'),
							_1: {
								ctor: '::',
								_0: A2(_ferstl$depgraph_maven_plugin$Main$toMaybe, model.scopeFilter.showRuntime, 'runtime'),
								_1: {
									ctor: '::',
									_0: A2(_ferstl$depgraph_maven_plugin$Main$toMaybe, model.scopeFilter.showTest, 'test'),
									_1: {
										ctor: '::',
										_0: A2(_ferstl$depgraph_maven_plugin$Main$toMaybe, model.scopeFilter.showSystem, 'system'),
										_1: {
											ctor: '::',
											_0: A2(_ferstl$depgraph_maven_plugin$Main$toMaybe, model.scopeFilter.showImport, 'import'),
											_1: {ctor: '[]'}
										}
									}
								}
		...
		function (edge, dependency) {
			return A2(
				...
				A2(
					...
					{
						ctor: '::',
						_0: A2(_ferstl$depgraph_maven_plugin$Main$toMaybe, model.resolutionFilter.showIncluded, 'INCLUDED'),
						_1: {
							ctor: '::',
							_0: A2(_ferstl$depgraph_maven_plugin$Main$toMaybe, model.resolutionFilter.showConflicts, 'OMITTED_FOR_CONFLICT'),
							_1: {
								ctor: '::',
								_0: A2(_ferstl$depgraph_maven_plugin$Main$toMaybe, model.resolutionFilter.showDuplicates, 'OMITTED_FOR_DUPLICATE'),
								_1: {ctor: '[]'}
							}
						}
					}));
			...
			A2(
				...
				A2(
					...
					A2(
						_elm_lang$core$Dict$filter,
						scopeFilter,
						A2(_elm_lang$core$Dict$filter, resolutionFilter, model.graphLookup.dependencyDict))))));
};
var _ferstl$depgraph_maven_plugin$Main$layout = function () {
	var defaultLayout = _justinmimbs$elm_arc_diagram$ArcDiagram$defaultLayout;
	return _elm_lang$core$Native_Utils.update(
		defaultLayout,
		{labelWidth: 400});
}();
var _ferstl$depgraph_maven_plugin$Main$updateScopeFilter = F2(
	function (scope, scopeFilter) {
		var _p7 = scope;
		switch (_p7.ctor) {
			case 'Compile':
				return _elm_lang$core$Native_Utils.update(
					scopeFilter,
					{showCompile: !scopeFilter.showCompile});
			case 'Provided':
				return _elm_lang$core$Native_Utils.update(
					scopeFilter,
					{showProvided: !scopeFilter.showProvided});
			case 'Runtime':
				return _elm_lang$core$Native_Utils.update(
					scopeFilter,
					{showRuntime: !scopeFilter.showRuntime});
			case 'Test':
				return _elm_lang$core$Native_Utils.update(
					scopeFilter,
					{showTest: !scopeFilter.showTest});
			case 'System':
				return _elm_lang$core$Native_Utils.update(
					scopeFilter,
					{showSystem: !scopeFilter.showSystem});
			default:
				return _elm_lang$core$Native_Utils.update(
					scopeFilter,
					{showImport: !scopeFilter.showImport});
		}
	});
var _ferstl$depgraph_maven_plugin$Main$updateResolutionFilter = F2(
	function (nodeResolution, edgeFilter) {
		var _p8 = nodeResolution;
		switch (_p8.ctor) {
			case 'Included':
				return _elm_lang$core$Native_Utils.update(
					edgeFilter,
					{showIncluded: !edgeFilter.showIncluded});
			case 'OmittedForDuplicate':
				return _elm_lang$core$Native_Utils.update(
					edgeFilter,
					{showDuplicates: !edgeFilter.showDuplicates});
			default:
				return _elm_lang$core$Native_Utils.update(
					edgeFilter,
					{showConflicts: !edgeFilter.showConflicts});
		}
	});
var _ferstl$depgraph_maven_plugin$Main$update = F2(
	function (msg, model) {
		var _p9 = msg;
		switch (_p9.ctor) {
			case 'SelectGraphNode':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							selectedNode: A2(_ferstl$depgraph_maven_plugin$Main$toggleMaybe, _p9._0, model.selectedNode)
						}),
			...
			case 'ToggleResolution':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							resolutionFilter: A2(_ferstl$depgraph_maven_plugin$Main$updateResolutionFilter, _p9._0, model.resolutionFilter)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ToggleScope':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							scopeFilter: A2(_ferstl$depgraph_maven_plugin$Main$updateScopeFilter, _p9._0, model.scopeFilter)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SetIncludeFilter':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{includeFilter: _p9._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{excludeFilter: _p9._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _ferstl$depgraph_maven_plugin$Main$Artifact = F3(
	function (a, b, c) {
		return {id: a, artifactId: b, version: c};
	});
var _ferstl$depgraph_maven_plugin$Main$Dependency = F4(
	function (a, b, c, d) {
		return {from: a, to: b, resolution: c, scopes: d};
	});
var _ferstl$depgraph_maven_plugin$Main$DependencyGraph = F2(
	function (a, b) {
		return {artifacts: a, dependencies: b};
	});
var _ferstl$depgraph_maven_plugin$Main$GraphLookup = F2(
	function (a, b) {
		return {artifactDict: a, dependencyDict: b};
	});
var _ferstl$depgraph_maven_plugin$Main$toGraphLookup = function (dependencyGraph) {
	var dependencyDict = _elm_lang$core$Dict$fromList(
		A2(
			_elm_lang$core$List$map,
			function (dependency) {
				return {
					ctor: '_Tuple2',
					_0: {ctor: '_Tuple2', _0: dependency.from, _1: dependency.to},
					_1: dependency
				};
			},
			dependencyGraph.dependencies));
	var artifactDict = _elm_lang$core$Dict$fromList(
		A2(
			_elm_lang$core$List$map,
			function (artifact) {
				return {ctor: '_Tuple2', _0: artifact.id, _1: artifact};
			},
			dependencyGraph.artifacts));
	return A2(_ferstl$depgraph_maven_plugin$Main$GraphLookup, artifactDict, dependencyDict);
};
var _ferstl$depgraph_maven_plugin$Main$init = function (dependencyGraph) {
	return {
		ctor: '_Tuple2',
		_0: {
			graphLookup: _ferstl$depgraph_maven_plugin$Main$toGraphLookup(dependencyGraph),
			selectedNode: _elm_lang$core$Maybe$Nothing,
			resolutionFilter: {showIncluded: true, showDuplicates: false, showConflicts: false},
			scopeFilter: {showCompile: true, showProvided: true, showRuntime: true, showTest: true, showSystem: true, showImport: true},
			includeFilter: '',
			excludeFilter: ''
		},
		_1: _elm_lang$core$Platform_Cmd$none
...
var _ferstl$depgraph_maven_plugin$Main$ResolutionFilter = F3(
	function (a, b, c) {
		return {showIncluded: a, showConflicts: b, showDuplicates: c};
	});
var _ferstl$depgraph_maven_plugin$Main$ScopeFilter = F6(
	function (a, b, c, d, e, f) {
		return {showCompile: a, showProvided: b, showRuntime: c, showTest: d, showSystem: e, showImport: f};
	});
var _ferstl$depgraph_maven_plugin$Main$Model = F6(
	function (a, b, c, d, e, f) {
		return {graphLookup: a, selectedNode: b, resolutionFilter: c, scopeFilter: d, includeFilter: e, excludeFilter: f};
	});
var _ferstl$depgraph_maven_plugin$Main$Import = {ctor: 'Import'};
var _ferstl$depgraph_maven_plugin$Main$System = {ctor: 'System'};
var _ferstl$depgraph_maven_plugin$Main$Test = {ctor: 'Test'};
var _ferstl$depgraph_maven_plugin$Main$Runtime = {ctor: 'Runtime'};
var _ferstl$depgraph_maven_plugin$Main$Provided = {ctor: 'Provided'};
var _ferstl$depgraph_maven_plugin$Main$Compile = {ctor: 'Compile'};
var _ferstl$depgraph_maven_plugin$Main$OmittedForDuplicate = {ctor: 'OmittedForDuplicate'};
var _ferstl$depgraph_maven_plugin$Main$OmittedForConflict = {ctor: 'OmittedForConflict'};
var _ferstl$depgraph_maven_plugin$Main$Included = {ctor: 'Included'};
var _ferstl$depgraph_maven_plugin$Main$SetExcludeFilter = function (a) {
	return {ctor: 'SetExcludeFilter', _0: a};
};
var _ferstl$depgraph_maven_plugin$Main$SetIncludeFilter = function (a) {
	return {ctor: 'SetIncludeFilter', _0: a};
};
var _ferstl$depgraph_maven_plugin$Main$ToggleScope = function (a) {
	return {ctor: 'ToggleScope', _0: a};
};
var _ferstl$depgraph_maven_plugin$Main$scopeCheckbox = F3(
	function (isChecked, scope, labelText) {
		return A2(
						...
						_1: {
							...
							_1: {
								...
								_0: _elm_lang$html$Html_Events$onClick(
									_ferstl$depgraph_maven_plugin$Main$ToggleScope(scope)),
								_1: {ctor: '[]'}
							}
						}
					},
...
var _ferstl$depgraph_maven_plugin$Main$SelectGraphNode = function (a) {
	return {ctor: 'SelectGraphNode', _0: a};
};
var _ferstl$depgraph_maven_plugin$Main$ToggleResolution = function (a) {
	return {ctor: 'ToggleResolution', _0: a};
};
var _ferstl$depgraph_maven_plugin$Main$Light = {ctor: 'Light'};
var _ferstl$depgraph_maven_plugin$Main$Middle = {ctor: 'Middle'};
var _ferstl$depgraph_maven_plugin$Main$Dark = {ctor: 'Dark'};
var _ferstl$depgraph_maven_plugin$Main$filterBar = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('filter-bar'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('filter-bar__column filter-bar__column--stretch'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('text-filter'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('text-filter__item'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Includes: '),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$input,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onInput(_ferstl$depgraph_maven_plugin$Main$SetIncludeFilter),
													_1: {ctor: '[]'}
												}
											},
											{ctor: '[]'}),
								...
								_0: A2(
									...
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Excludes: '),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$input,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onInput(_ferstl$depgraph_maven_plugin$Main$SetExcludeFilter),
														_1: {ctor: '[]'}
													}
												},
												{ctor: '[]'}),
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('filter-bar__column'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('checkbox-filter'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('checkbox-filter__title'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('checkbox-filter__controls'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('checkbox-group'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('checkbox-group__sub'),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
																...
																{ctor: '[]'},
																{
																	...
																	_0: A2(
																		_elm_lang$html$Html$input,
																		{
																			...
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$checked(model.resolutionFilter.showIncluded),
																				_1: {
																					ctor: '::',
																					_0: _elm_lang$html$Html_Events$onClick(
																						_ferstl$depgraph_maven_plugin$Main$ToggleResolution(_ferstl$depgraph_maven_plugin$Main$Included)),
																					_1: {ctor: '[]'}
																				}
																			}
																		},
																		...
																		_0: _elm_lang$html$Html_Attributes$style(
																			{
																				...
																				_0: {
																					ctor: '_Tuple2',
																					_0: 'color',
																					_1: _ferstl$depgraph_maven_plugin$Main$edgeColorDuplicate(_ferstl$depgraph_maven_plugin$Main$Dark)
																				},
																				_1: {ctor: '[]'}
																			}),
																		_1: {ctor: '[]'}
																	},
																	{
																		...
																		_0: A2(
																			_elm_lang$html$Html$input,
																			{
																				...
																				_1: {
																					ctor: '::',
																					_0: _elm_lang$html$Html_Attributes$checked(model.resolutionFilter.showDuplicates),
																					_1: {
																						ctor: '::',
																						_0: _elm_lang$html$Html_Events$onClick(
																							_ferstl$depgraph_maven_plugin$Main$ToggleResolution(_ferstl$depgraph_maven_plugin$Main$OmittedForDuplicate)),
																						_1: {ctor: '[]'}
																					}
																				}
																			},
																			...
																			_0: _elm_lang$html$Html_Attributes$style(
																				{
																					...
																					_0: {
																						ctor: '_Tuple2',
																						_0: 'color',
																						_1: _ferstl$depgraph_maven_plugin$Main$edgeColorConflict(_ferstl$depgraph_maven_plugin$Main$Dark)
																					},
																					_1: {ctor: '[]'}
																				}),
																			_1: {ctor: '[]'}
																		},
																		{
																			...
																			_0: A2(
																				_elm_lang$html$Html$input,
																				{
																					...
																					_1: {
																						ctor: '::',
																						_0: _elm_lang$html$Html_Attributes$checked(model.resolutionFilter.showConflicts),
																						_1: {
																							ctor: '::',
																							_0: _elm_lang$html$Html_Events$onClick(
																								_ferstl$depgraph_maven_plugin$Main$ToggleResolution(_ferstl$depgraph_maven_plugin$Main$OmittedForConflict)),
																							_1: {ctor: '[]'}
																						}
																					}
																				},
																			...
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html$text('Conflict'),
																				_1: {ctor: '[]'}
																			}
																		}),
																	_1: {ctor: '[]'}
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Scopes: '),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
												...
												_0: A2(
													...
													},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: A3(_ferstl$depgraph_maven_plugin$Main$scopeCheckbox, model.scopeFilter.showCompile, _ferstl$depgraph_maven_plugin$Main$Compile, 'Compile'),
																_1: {
																	ctor: '::',
																	_0: A3(_ferstl$depgraph_maven_plugin$Main$scopeCheckbox, model.scopeFilter.showProvided, _ferstl$depgraph_maven_plugin$Main$Provided, 'Provided'),
																	_1: {
																		ctor: '::',
																		_0: A3(_ferstl$depgraph_maven_plugin$Main$scopeCheckbox, model.scopeFilter.showRuntime, _ferstl$depgraph_maven_plugin$Main$Runtime, 'Runtime'),
																		_1: {ctor: '[]'}
																	}
																}
															}),
														_1: {
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: A3(_ferstl$depgraph_maven_plugin$Main$scopeCheckbox, model.scopeFilter.showTest, _ferstl$depgraph_maven_plugin$Main$Test, 'Test'),
																	_1: {
																		ctor: '::',
																		_0: A3(_ferstl$depgraph_maven_plugin$Main$scopeCheckbox, model.scopeFilter.showSystem, _ferstl$depgraph_maven_plugin$Main$System, 'System'),
																		_1: {
																			ctor: '::',
																			_0: A3(_ferstl$depgraph_maven_plugin$Main$scopeCheckbox, model.scopeFilter.showImport, _ferstl$depgraph_maven_plugin$Main$Import, 'Import'),
																			_1: {ctor: '[]'}
																		}
																	}
																}),
...
var _ferstl$depgraph_maven_plugin$Main$paintNothingSelected = F2(
	function (model, toLabel) {
		return {
			viewLabel: function (node) {
				return A2(
					_ferstl$depgraph_maven_plugin$DistancePaint$viewLabelDimmed,
			...
			colorNode: _elm_lang$core$Basics$always(
				_ferstl$depgraph_maven_plugin$Main$edgeColorIncluded(_ferstl$depgraph_maven_plugin$Main$Dark)),
			colorEdge: A2(_ferstl$depgraph_maven_plugin$Main$edgeColor, model.graphLookup.dependencyDict, _ferstl$depgraph_maven_plugin$Main$Middle)
		};
	});
var _ferstl$depgraph_maven_plugin$Main$edgeColorFromDistance = F3(
	function (dependencyDict, edge, distance) {
		var _p10 = distance;
		if (_p10.ctor === 'Just') {
			return _elm_lang$core$Native_Utils.eq(_p10._0, 0) ? A3(_ferstl$depgraph_maven_plugin$Main$edgeColor, dependencyDict, _ferstl$depgraph_maven_plugin$Main$Dark, edge) : A3(_ferstl$depgraph_maven_plugin$Main$edgeColor, dependencyDict, _ferstl$depgraph_maven_plugin$Main$Middle, edge);
		} else {
			return A3(_ferstl$depgraph_maven_plugin$Main$edgeColor, dependencyDict, _ferstl$depgraph_maven_plugin$Main$Light, edge);
		}
	});
var _ferstl$depgraph_maven_plugin$Main$drawGraph = function (model) {
	var toLabel = function (node) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			'not found',
			A2(
				...
				function (artifact) {
					return A2(
						_elm_lang$core$Basics_ops['++'],
						artifact.artifactId,
						A2(_elm_lang$core$Basics_ops['++'], ':', artifact.version));
				},
				A2(_elm_lang$core$Dict$get, node, model.graphLookup.artifactDict)));
	};
	var edges = _ferstl$depgraph_maven_plugin$Main$filterEdges(model);
	var _p11 = _justinmimbs$elm_arc_diagram$AcyclicDigraph$fromEdges(edges);
	if (_p11.ctor === 'Err') {
		return A2(_ferstl$depgraph_maven_plugin$Main$viewCycles, toLabel, _p11._0);
	} else {
		var _p12 = _p11._0;
		var paint = A2(
			_elm_lang$core$Maybe$withDefault,
			A2(_ferstl$depgraph_maven_plugin$Main$paintNothingSelected, model, toLabel),
			A2(
				_elm_lang$core$Maybe$map,
				A3(
					_ferstl$depgraph_maven_plugin$DistancePaint$basicPaint,
					toLabel,
					_ferstl$depgraph_maven_plugin$Main$edgeColorFromDistance(model.graphLookup.dependencyDict),
					_p12),
				model.selectedNode));
		return A3(_justinmimbs$elm_arc_diagram$ArcDiagram$view, _ferstl$depgraph_maven_plugin$Main$layout, paint, _p12);
	}
};
var _ferstl$depgraph_maven_plugin$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _ferstl$depgraph_maven_plugin$Main$filterBar(model),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('graph'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							function (node) {
								return _ferstl$depgraph_maven_plugin$Main$SelectGraphNode(node);
							},
							_ferstl$depgraph_maven_plugin$Main$drawGraph(model)),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _ferstl$depgraph_maven_plugin$Main$main = _elm_lang$html$Html$programWithFlags(
	{
		init: _ferstl$depgraph_maven_plugin$Main$init,
		view: _ferstl$depgraph_maven_plugin$Main$view,
		update: _ferstl$depgraph_maven_plugin$Main$update,
						...
						A2(
							...
							function (from) {
								return A2(
										...
										return A2(
											...
											function (scopes) {
												return A2(
													...
													function (to) {
														return _elm_lang$core$Json_Decode$succeed(
															{from: from, resolution: resolution, scopes: scopes, to: to});
													},
									...
									A2(_elm_lang$core$Json_Decode$field, 'resolution', _elm_lang$core$Json_Decode$string));
							},
						...
						return A2(
							...
							function (id) {
								return A2(
									...
									function (version) {
										return _elm_lang$core$Json_Decode$succeed(
											{artifactId: artifactId, id: id, version: version});
									},
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _ferstl$depgraph_maven_plugin$Main$main !== 'undefined') {
    _ferstl$depgraph_maven_plugin$Main$main(Elm['Main'], 'Main', undefined);
}
